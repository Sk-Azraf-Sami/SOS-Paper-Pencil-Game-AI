...
def setup_labels(frame, player1, player2):
    ...
    return player1_label, player2_label, player1_name_label, player2_name_label

def setup_board(frame, board_size, handle_click):
...
def check_winner(board, row, col, char, player_turn, player1_score, player2_score):
    if check_sos(board, row, col, char):
